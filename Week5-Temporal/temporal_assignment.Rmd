...
rm(list=ls())
getwd()
setwd("~/GitHub/QB2017_Polezhaeva/Week5-Temporal/")
package.list <- c('vegan', 'tidyr', 'dplyr', 'codyn', 'ggplot2', 'cowplot', 'Mullerplot', 'RColorBrewer', 'reshape2', 'lubricate', 'TTR', 'xtable', 'multcomp', 'pander', 'png', 'grid', 'tseries', 'nlme', 'forecast', 'lsmeans')
