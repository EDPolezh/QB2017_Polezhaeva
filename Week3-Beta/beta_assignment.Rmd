...
> ***Answer 3c***:  If $\beta$ is defined additively it means that beta-diversity is number of species that are, in averege, present in regional species pool but not present in each site within the region.
